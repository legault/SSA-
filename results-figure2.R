...
########## Irregular
## Create irregular1 environmental values
set.seed(20170731)
...
## Create irregular2 environmental values
set.seed(20170731)
randenv2 <- rnorm(length(times), mean = 1.5, sd = .5)
## Create function that interpolates these values
randenvfun2 <- splinefun(times, randenv2)
# Parameters, exponential growth (irregular1)
param1 <- list(b = .003,
               d = .0027,
               exponentialfun,
               env = randenvfun1)
param1 <- unlist(param1) # collapse to one-dimensional list
# Parameters, exponential growth (irregular2)
param2 <- list(b = .003,
               d = .0027,
               exponentialfun,
               env = randenvfun2)
...
########## Irregular
# Parameters, logistic growth (irregular1)
param1 <- list(b1 = .003,
              d1 = .0027,
              d2 = .000003,
              logisticfun,
              env = randenvfun1)
param1 <- unlist(param1) # collapse to one-dimensional list
# Parameters, logistic growth (irregular2)
param2 <- list(b1 = .003,
              d1 = .0027,
              d2 = .000003,
              logisticfun,
